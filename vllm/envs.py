...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    # retains only replay-reachable checkpoints. Positive values also retain
    # checkpoints at the specified interval boundaries. Fine-grained PMU tail
    # snapshots are retained separately when partial prefix hits are enabled.
